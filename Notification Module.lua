...
*yes, it's open source, don't be a leech
]]
local Notif = {}
function Notif(title, body, duration, iconID, mainbutton, button2, waituntilanswer, callback)
    ...
    -- I have separate functions to make it appear and disappear so you can trigger them anytime
	function Appear()
    	for i = 1, 0, -0.2 do
    ...
    if mainbutton ~= nil then
    	...
    	Button1.Position = UDim2.new(0, 0, 0, 0) --1.02999997
